...
>
> **通过 BRAT 安装增强版：** 在 Obsidian 中安装并启用 BRAT，选择 **Add a beta plugin**，填入 `Backtthefuture/claudian-antigravity`，选择发布版本 `2.2.7-antigravity.2`，然后安装并启用 Claudian。已有 Claudian 的库会更新同一个插件；首次替换前请备份插件目录和 `.claudian/`。
>
